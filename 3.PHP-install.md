...
```
dnf install -y php php-cli php-common php-fpm php-mysqlnd php-xml php-mbstring php-gd php-opcache
```
...
_PHP to connect to Oracle databases:_
```
dnf install php-oci8  -y
```
